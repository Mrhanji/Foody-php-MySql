...
<div id="divs">
 ...
 <?php 
   $data=mysqli_query($conn,"SELECT  p.product_id,r.city_name,p.name,p.image,p.mrp,r.name as rname  FROM products p INNER JOIN restaurants r ON r.restaurants_id=p.restaurants_id ORDER BY p.product_id DESC; ");
 ...
 ?>
  <tr>
    ...
    <td>₹<?php echo $panda['mrp']; ?></td>
     <td><a href="<?php echo $baseurl.'forms/index.php?query='.$title;?>" target="_blank"><?php echo $panda['rname'];?></a></td>
