...
$id=$_SESSION['userid'];
$info=mysqli_query($conn,"SELECT address ,email FROM userlist WHERE user_id='{$id}' ;");
                    ...
                    <div class="food-menu-box">
                        ...
                        <div class="row grid">
                          ...
                          header("Location: login.php");
                                ...
                                $data=mysqli_query($conn,"SELECT *FROM user_cart u  INNER JOIN products p ON p.product_id=u.product_id WHERE u.user_id='{$id}' ");
...
function checkout() {
  ...
  if (confirm("You really want to order?")) {
   window.location.replace("controller/ordernow.php?phash=<?php echo base64_encode($_SESSION['userid']).'&uemail='.$email;?>");
